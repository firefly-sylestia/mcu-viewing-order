...
export default function App() {
  ...
  const { pushToCloud, pushBeforeLogout, lastSynced, syncing, conflict, resolveUseRemote, resolveKeepLocal } = useCloudSync(user, actions, profileName, setActions, setProfileName);
